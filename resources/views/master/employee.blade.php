...
if ($days <= 0){ $count++; } @endphp @endforeach <!DOCTYPE html>
    <html lang="en">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <div class="col-md-2 offset-md-10">
                                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                    ...
                                    <a href="{{route('employee.bookroom.store.get')}}"><button
                                            class="btn btn-outline-success mr-sm-2">Đặt phòng</button></a>
                                    @else
                                    <a href="{{route('getdangky')}}"><button
                                            class="btn btn-outline-success mr-sm-2">Thêm nhân viên</button></a>
                                    @endif
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            id="dropdownMenuButton" class="my-2 my-sm-0" data-toggle="dropdown"
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            @endphp
                                            <a href="{{route('employee.thongtin',$id)}}"><button
                                                    class="btn btn-outline-secondary"
                                                    style="margin: auto ; width: 160px">Thông tin</button></a>
                                            <a href="{!! route('getlogout') !!}"><button class="btn btn-outline-danger"
                                                    style="margin: auto ; width: 160px">Đăng xuất</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
