        ...
        <div class="row">
          ...
          <div class="col-lg-4">
              <div class="p-4 mb-3 bg-white">
                  <h2 class="h5 text-black mb-3">Phòng Vip</h2>
                  ...
                  <p class="mb-0">- Theo giờ: 120.000đ (2 giờ ).</p>
                  <p class="mb-0">- Theo ngày: 450.000đ.</p>
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        ...
                        <input type="hidden" name="nameRoom" value="Vip">
