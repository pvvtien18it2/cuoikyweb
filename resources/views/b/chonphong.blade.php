        ...
        <table class="table table-bordered table-responsive-md table-striped">
            <tr>
                <td>
                    ...
                    @else
                    <div class="btn-group">
                        <button style="color: yellow" type="button" class="btn btn-success dropdown-toggle" id = "drop_down"  data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-check"> {{$r1->tenP}} ({{$r1->loaiP}})</i>
                        </button>
                        <div class="dropdown-menu" style="width: 300px">
                            <form action="{{route('employee.updatechonphongkhach')}}" method="head" style="width: 280px ; padding: 5px">
                                @csrf
                            ...
                            <a href="{{route('employee.delaykhach',$idNow->id)}}"><button class="btn btn-success">Chọn</button></a>
                            @else
                ...
                <td>
                    @if ($arr != null)
                            ...
                            @endphp
                                    ...
                                    @else
                                    <div class="btn-group">
                                    <button style="color: yellow" type="button"class="btn btn-success dropdown-toggle" id = "drop_down"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        @endphp
                                            @if($checkMin >= 4 && $day_create->isPast())
                                                ...
                                                <a href="{{route('employee.delay.khach',$idNow->id)}}"><button class="btn btn-success">Chọn</button></a>
                                            @else
                                                <button type="submit" class="btn btn-success">Chọn</button>
                                                </form>
                                            @endif
...
<div class="row">
    ...
    <a href="{{ route('employee.huy.khach',$idNow->id) }}"><button class="btn btn-danger">Hủy</button></a>
</div>
