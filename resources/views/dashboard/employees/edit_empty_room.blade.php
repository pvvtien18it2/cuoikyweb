...
<div class="container">
        <div class="row">
                <form action="{!! route('empty.room.update',$data->id )!!}" method="post">
                        @csrf
                        @method('put')
...
Trader' !!}
                                    ...
                                    <td colspan="3">
                                            @if ($data->tinhtrang =='1')
                                                ...
                                                @endif
                                            @elseif($data->tinhtrang =='0')
                                                    <button type="button" class="btn btn-danger" style="width: 200px; text-align: center" value="1">Trống</button>
                                            @endif
                                    </td>
                                    <td colspan="1">
