...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- //for-mobile-apps -->
    <link href="{!! url('resources/theme/css/bootstrap.css') !!}" rel="stylesheet" type="text/css" media="all" />
    <link rel="stylesheet" href="{!! url('resources/theme/css/flexslider.css') !!}" type="text/css" media="screen" property="" />
    <link rel="stylesheet" type="text/css" href="{!! url('resources/theme/css/zoomslider.css') !!}" />
    <link rel="stylesheet" type="text/css" href="{!! url('resources/theme/css/style.css') !!}" />
    <link href="{!! url('resources/theme/css/font-awesome.css') !!}" rel="stylesheet">
    <script type="text/javascript" src="{!! url('resources/theme/js/modernizr-2.6.2.min.js') !!}"></script>
    <!--/web-fonts-->
...
<script type="text/javascript" src="{!! url('resources/theme/js/jquery.zoomslider.min.js') !!}"></script>
<!-- search-jQuery -->
<script src="{!! url('resources/theme/js/main.js') !!}"></script>

<!--/script-->
<script src="{!! url('resources/theme/js/simplePlayer.js') !!}"></script>
<script>
    $("document").ready(function() {
        $("#video").simplePlayer();
    });
...
<!-- flexSlider -->
<script defer src="{!! url('resources/theme/js/jquery.flexslider.js') !!}"></script>
...
<!-- Calendar -->
<link rel="stylesheet" href="{!! url('resources/theme/css/jquery-ui.css') !!}" />
<script src="{!! url('resources/theme/js/jquery-ui.js') !!}"></script>
<script>
    $(function() {
...
<!-- //Calendar -->
<script type="text/javascript" src="{!! url('resources/theme/js/move-top.js') !!}"></script>
<script type="text/javascript" src="{!! url('resources/theme/js/easing.js') !!}"></script>
...
<script src="{!! url('resources/theme/js/bootstrap.js') !!}"></script>
